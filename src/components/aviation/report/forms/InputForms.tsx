...
export const ReportInputType1 = (params) => {
  const { rightContents, placeholder, text, onChange } = params;
...
export const ReportDateType1 = (params) => {
  const { rightContents, placeholder } = params;
  return (
    <div className="tw-flex tw-gap-4 tw-grow" key={uuidv4()}>
      <input type="date" id="name" name="name" placeholder={placeholder} className="av-input-1 tw-rounded-lg" />
      {rightContents !== null ? rightContents : null}
    </div>
  );
};
...
export const ReportInputWithLeftLabel = (params) => {
  ...
  return (
    <div className="tw-flex" key={uuidv4()}>
      ...
      <input type="text" id="name" name="name" className="av-input-1 tw-rounded-r-lg" />
    </div>
  );
};
...
export const ReportInputWithRightLabel = (params) => {
  ...
  return (
    <div key={uuidv4()} className="tw-flex tw-grow">
      <input type="text" id="name" name="name" className="av-input-1 tw-rounded-l-lg" />

...
const initListData = {
  ...listBaseState,
  listApiPath: 'avn/policy/manuals',
...
function SafetyManual() {
  ...
  const { enterSearch, searchParam, list, changeSearchInput, initSearchInput, clear, search, goDetailPage } = state;

  // TODO : 검색 파라미터 나열
  const { jobType, manualName, languageType } = searchParam;
